-- Script SQL pour la création des tables principales du TMS
-- À exécuter dans votre base de données TMSDBv3 via DBeaver
...
-- Exemple d'utilisation : créer un schéma pour le tenant 1
-- Décommentez la ligne suivante pour créer un tenant de test
